...
![Ablation study](../outputs/latest/figures/ablation_study.png)
...
![Backtest drawdown oos](../outputs/latest/figures/backtest_drawdown_oos.png)
...
![Backtest equity oos](../outputs/latest/figures/backtest_equity_oos.png)
...
![Backtest exposure oos](../outputs/latest/figures/backtest_exposure_oos.png)
...
![Backtest rolling sharpe oos](../outputs/latest/figures/backtest_rolling_sharpe_oos.png)
...
![Backtest turnover oos](../outputs/latest/figures/backtest_turnover_oos.png)
...
![Bootstrap forest brier](../outputs/latest/figures/bootstrap_forest_brier.png)
...
![Bootstrap forest log loss](../outputs/latest/figures/bootstrap_forest_log_loss.png)
...
![Bootstrap forest macro f1](../outputs/latest/figures/bootstrap_forest_macro_f1.png)
...
![Bootstrap forest recall bear](../outputs/latest/figures/bootstrap_forest_recall_bear.png)
...
![Bootstrap forest recall stress](../outputs/latest/figures/bootstrap_forest_recall_stress.png)
...
![Confusion matrix macd probabilistic 20](../outputs/latest/figures/confusion_matrix_macd_probabilistic_20.png)
...
![Confusion matrix macd probabilistic 40](../outputs/latest/figures/confusion_matrix_macd_probabilistic_40.png)
...
![Confusion matrix macd probabilistic 60](../outputs/latest/figures/confusion_matrix_macd_probabilistic_60.png)
...
![Confusion matrix raemf mc 20](../outputs/latest/figures/confusion_matrix_raemf_mc_20.png)
...
![Confusion matrix raemf mc 40](../outputs/latest/figures/confusion_matrix_raemf_mc_40.png)
...
![Confusion matrix raemf mc 60](../outputs/latest/figures/confusion_matrix_raemf_mc_60.png)
...
![Confusion matrix random forest full features 20](../outputs/latest/figures/confusion_matrix_random_forest_full_features_20.png)
...
![Confusion matrix random forest full features 40](../outputs/latest/figures/confusion_matrix_random_forest_full_features_40.png)
...
![Confusion matrix random forest full features 60](../outputs/latest/figures/confusion_matrix_random_forest_full_features_60.png)
...
![Confusion matrix xgboost full features 20](../outputs/latest/figures/confusion_matrix_xgboost_full_features_20.png)
...
![Confusion matrix xgboost full features 40](../outputs/latest/figures/confusion_matrix_xgboost_full_features_40.png)
...
![Confusion matrix xgboost full features 60](../outputs/latest/figures/confusion_matrix_xgboost_full_features_60.png)
...
![Du bao moi nhat theo horizon](../outputs/latest/figures/du_bao_moi_nhat_theo_horizon.png)
...
![Ebm shape plot 20](../outputs/latest/figures/ebm_shape_plot_20.png)
...
![Ebm shape plot 40](../outputs/latest/figures/ebm_shape_plot_40.png)
...
![Ebm shape plot 60](../outputs/latest/figures/ebm_shape_plot_60.png)
...
![Egarch conditional volatility](../outputs/latest/figures/egarch_conditional_volatility.png)
...
![Fan chart monte carlo 20](../outputs/latest/figures/fan_chart_monte_carlo_20.png)
...
![Fan chart monte carlo 40](../outputs/latest/figures/fan_chart_monte_carlo_40.png)
...
![Fan chart monte carlo 60](../outputs/latest/figures/fan_chart_monte_carlo_60.png)
...
![Feature importance raemf mc 20](../outputs/latest/figures/feature_importance_raemf_mc_20.png)
...
![Feature importance raemf mc 40](../outputs/latest/figures/feature_importance_raemf_mc_40.png)
...
![Feature importance raemf mc 60](../outputs/latest/figures/feature_importance_raemf_mc_60.png)
...
![Hmm regime overlay](../outputs/latest/figures/hmm_regime_overlay.png)
...
![Local explanation latest 20](../outputs/latest/figures/local_explanation_latest_20.png)
...
![Local explanation latest 40](../outputs/latest/figures/local_explanation_latest_40.png)
...
![Local explanation latest 60](../outputs/latest/figures/local_explanation_latest_60.png)
...
![Loi suat theo thoi gian](../outputs/latest/figures/loi_suat_theo_thoi_gian.png)
...
![Metric theo fold walk forward](../outputs/latest/figures/metric_theo_fold_walk_forward.png)
...
![Phan phoi loi suat](../outputs/latest/figures/phan_phoi_loi_suat.png)
...
![Phan phoi lop theo horizon](../outputs/latest/figures/phan_phoi_lop_theo_horizon.png)
...
![Precision recall bear 20](../outputs/latest/figures/precision_recall_bear_20.png)
...
![Precision recall bear 40](../outputs/latest/figures/precision_recall_bear_40.png)
...
![Precision recall bear 60](../outputs/latest/figures/precision_recall_bear_60.png)
...
![Precision recall stress 20](../outputs/latest/figures/precision_recall_stress_20.png)
...
![Precision recall stress 40](../outputs/latest/figures/precision_recall_stress_40.png)
...
![Precision recall stress 60](../outputs/latest/figures/precision_recall_stress_60.png)
...
![Reliability diagram 20](../outputs/latest/figures/reliability_diagram_20.png)
...
![Reliability diagram 40](../outputs/latest/figures/reliability_diagram_40.png)
...
![Reliability diagram 60](../outputs/latest/figures/reliability_diagram_60.png)
...
![So sanh balanced accuracy](../outputs/latest/figures/so_sanh_balanced_accuracy.png)
...
![So sanh brier](../outputs/latest/figures/so_sanh_brier.png)
...
![So sanh ece](../outputs/latest/figures/so_sanh_ece.png)
...
![So sanh log loss](../outputs/latest/figures/so_sanh_log_loss.png)
...
![So sanh macro f1](../outputs/latest/figures/so_sanh_macro_f1.png)
...
![So sanh mcc](../outputs/latest/figures/so_sanh_mcc.png)
...
![So sanh recall bear](../outputs/latest/figures/so_sanh_recall_bear.png)
...
![So sanh recall stress](../outputs/latest/figures/so_sanh_recall_stress.png)
...
![Vnindex va phan chia du lieu](../outputs/latest/figures/vnindex_va_phan_chia_du_lieu.png)
...
![Xac suat filtered hmm](../outputs/latest/figures/xac_suat_filtered_hmm.png)
